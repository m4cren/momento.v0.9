const postsToggleBtn = document.getElementById('postsToggleBtn');
const followingToggleBtn = document.getElementById('followingToggleBtn');
const followersToggleBtn = document.getElementById('followersToggleBtn');
...
postsToggleBtn.addEventListener('click', function(){
     if(postContainer.classList.contains('hidden')){
          ...
          postsToggleBtn.style.border = '2px solid black';
          followingToggleBtn.style.border = 'none';
          followersToggleBtn.style.border = 'none';
     }
});
followingToggleBtn.addEventListener('click', function(){
     if(followingContainer.classList.contains('hidden')){
          postContainer.classList.add('hidden');
          followersContainer.classList.add('hidden');
          followingContainer.classList.remove('hidden');
          postsToggleBtn.style.border = 'none';
          followingToggleBtn.style.border = '2px solid black';
          followersToggleBtn.style.border = 'none';
     }
});
followersToggleBtn.addEventListener('click', function(){
     if(followersContainer.classList.contains('hidden')){
          postContainer.classList.add('hidden');
          followersContainer.classList.remove('hidden');
          followingContainer.classList.add('hidden');
          postsToggleBtn.style.border = 'none';
          followingToggleBtn.style.border = 'none';
          followersToggleBtn.style.border = '2px solid black';
     }
});

const editProfileBtn = document.getElementById('edit-profile-picture');
const editProfileContainer = document.querySelector('.edit-profile-picture-popup');
const editCoverBtn = document.getElementById('edit-cover-picture');
const editCoverContainer = document.querySelector('.edit-cover-picture-popup');
const exitEditBtn = document.querySelector('.exit-edit')
const exitEditCoverBtn = document.querySelector('.exit-edit-cover')
...
editCoverBtn.addEventListener('click', function(){
     if(editCoverContainer.classList.contains('hidden')){
          editCoverContainer.classList.remove('hidden');
     }
});
exitEditCoverBtn.addEventListener('click', function(){
     editCoverContainer.classList.add('hidden');
});
